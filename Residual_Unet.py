...
#     conv = conv_block(conv, filters, kernel_size=kernel_size, padding=padding, strides=strides)#adding
...
def upsample_concat_block(x, xskip):
 ...
 #     outputs = keras.layers.Conv2D(nclasses, (1, 1), padding="same", activation="softmax")(u4)
    ...
    outputs = keras.layers.Conv2D(nclasses, (1, 1), padding="same", activation="sigmoid")(d4)
